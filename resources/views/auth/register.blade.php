...
<body>
                    ...
                    <div class="card col-lg-4 mx-auto">
                        <div class="card-body px-5 py-5">
                            ...
                            <form action="{{route('register')}}" method="POST">
                                ...
                                <p class="sign-up text-center">Already have an Account?<a href="{{route('login')}}"> Sign Up</a>
                                </p>
    ...
    {{-- end admin DOM components --}}
    {{-- end corona-free-dark-bootstrap-admin-template --}}
